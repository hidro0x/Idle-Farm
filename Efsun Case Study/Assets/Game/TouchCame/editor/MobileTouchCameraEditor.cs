...
namespace YigitDurmus {
  ...
  public class MobileTouchCameraEditor : CustomInspector {
    ...
    private Vector3 DrawSphereHandle(Vector3 point, float handleSize) {
      ...
      var fmh_82_44_638586418141227610 = Quaternion.identity; return Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.SphereHandleCap);
#else
...
#if UNITY_5_6_OR_NEWER
      var fmh_91_56_638586418141250467 = Quaternion.identity; Vector3 pointNew = Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.DotHandleCap);
#else
